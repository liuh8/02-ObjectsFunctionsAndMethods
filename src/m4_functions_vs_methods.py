...
def try_methods():
    fried = rg.SimpleTurtle()
    fried.pen = rg.Pen('brown', 5)
    fried.forward(150)
    fried.left(90)
    fried.forward(50)
    fried.backward(100)
...
def try_methods_and_functions():
    rice = rg.SimpleTurtle()
    rice.pen = rg.Pen('blue', 5)

    rice.forward(150)

    rice.speed = 1
    draw_many_squares(rice, 2, 100, 15)

    rice.speed = 5
    rice.pen = rg.Pen('red', 5)
    draw_many_squares(rice, 10, 50, 15)

    rice.speed = 100
    rice.pen = rg.Pen('red', 35)
    draw_many_squares(rice, 8, 300, 60)

    rice.pen = rg.Pen('black', 3)
